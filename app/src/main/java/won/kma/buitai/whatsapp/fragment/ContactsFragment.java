...
public class ContactsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerViewContactsList = (RecyclerView)ContactsView.findViewById(R.id.recycleview_contacts_list);
        recyclerViewContactsList.setLayoutManager(new LinearLayoutManager(getContext()));
    ...
    public static class ContactsViewHolder extends RecyclerView.ViewHolder {
        ...
        public ContactsViewHolder(@NonNull View itemView) {
            ...
            onlineIcon = (CircleImageView)itemView.findViewById(R.id.image_online);
        }
    }
